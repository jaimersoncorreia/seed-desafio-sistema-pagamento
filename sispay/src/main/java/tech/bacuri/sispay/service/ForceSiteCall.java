...
public class ForceSiteCall {
    public static void fromExactlyPoint(Class<?> originalSiteCall) {
        ...
        StackTraceElement classSiteCallElement = Thread.currentThread().getStackTrace()[3];
    ...
    public static void fromOriginalPoint(Class<?> originalSiteCall) {
        ...
        boolean foundOriginalPoint = Stream.of(traceElements).anyMatch(traceElement -> originalSiteCall.getName().equals(traceElement.getClassName()));
